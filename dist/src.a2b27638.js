...
},{"_css_loader":"node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/frappe-charts/dist/frappe-charts.esm.js":[function(require,module,exports) {
"use strict";
...
function initCode() {
  ...
  addAreaButton.addEventListener("click", function () {
    var Area = document.getElementById("submit-area").value;
    console.log(area);
  });
}
...
var getData = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(Area) {
    var url, res, data;
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 2:
            ...
            chart = new _frappeChartsEsm.Chart("#chart", {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "40825" + '/');
